package feathers.examples.componentsExplorer.screens
{
	...
	public class ToggleScreen extends PanelScreen
	{
		...
		//TOGGLESWITCH private var _toggleSwitch:ToggleSwitch;
		...
		protected function initializeHandler(event:Event):void
		{
			...
			//TOGGLESWITCH this._toggleSwitch = new ToggleSwitch();
			//TOGGLESWITCH this._toggleSwitch.isSelected = false;
			//TOGGLESWITCH this._toggleSwitch.addEventListener(Event.CHANGE, toggleSwitch_changeHandler);
			//TOGGLESWITCH this._toggleSwitchContainer.addChild(this._toggleSwitch);
