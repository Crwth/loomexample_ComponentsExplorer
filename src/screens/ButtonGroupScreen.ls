package feathers.examples.componentsExplorer.screens
{
	...
	//BUTTONGROUP import feathers.controls.ButtonGroup;
	...
	//STARLING import starling.core.Starling;
	...
	public class ButtonGroupScreen extends PanelScreen
	{
		...
		//BUTTONGROUP private var _buttonGroup:ButtonGroup;

		protected function initializeHandler(event:Event):void
		{
			this.layout = new AnchorLayout();

			//BUTTONGROUP this._buttonGroup = new ButtonGroup();
			/*BUTTONGROUP this._buttonGroup.dataProvider = new ListCollection(
			[
			...
			//BUTTONGROUP this._buttonGroup.layoutData = buttonGroupLayoutData;
			//BUTTONGROUP this.addChild(this._buttonGroup);
