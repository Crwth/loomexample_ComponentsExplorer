package feathers.examples.componentsExplorer.screens
{
	...
	//SCROLLTEXT import feathers.controls.ScrollText;
	...
	public class ScrollTextScreen extends PanelScreen
	{
		...
		//SCROLLTEXT private var _scrollText:ScrollText;

		protected function initializeHandler():void
		{
			this.layout = new AnchorLayout();

			//SCROLLTEXT this._scrollText = new ScrollText();
			...
			//SCROLLTEXT this._scrollText.layoutData = new AnchorLayoutData(0, 0, 0, 0);
			//SCROLLTEXT this.addChild(this._scrollText);
